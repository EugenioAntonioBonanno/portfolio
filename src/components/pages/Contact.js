...
// Handler for on click
  ...
  return (
    <>
      ...
      <div className="max-w-screen-xl md:mt-24 mx-3 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 md:mx-auto bg-gray-100 text-gray-800 rounded-lg shadow-lg">
      ...
      <section className='flex w-full justify-between mt-12 mb-5'>
