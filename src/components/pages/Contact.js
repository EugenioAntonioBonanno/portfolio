  ...
  return (
    <>
      <div className="text-center w-full">
        <svg className="text-gray-100 h-8 mx-auto" viewBox="0 0 150 29" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
      ...
      <div className="max-w-screen-xl md:mt-16 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 md:mx-auto bg-gray-100 text-gray-800 rounded-lg shadow-lg">
        <div className="flex flex-col justify-between">
          <div>
            <h2 className="text-4xl lg:text-5xl text-indigo-700 font-bold leading-tight">Lets talk about development!</h2>
        ...
        <form id='contact-form' onSubmit={handleSubmit(onSubmit)} noValidate>
          ...
          <div className="mt-8">
            ...
            <textarea
              ...
              placeholder='I would like you to help me build something wonderful'
            ></textarea>
        ...
        <section className='lg:flex max-w-screen-lg w-full justify-between mt-16 mb-7 lg:mt-24 md:mx-3'>
          ...
          <div className='mb-10 lg:mb-0 flex justify-center'>
            <a href="https://stackoverflow.com/users/10235667/gino" className='hover:opacity-70'>
              <svg xmlns="http://www.w3.org/2000/svg" height="50" viewBox="0 0 622 124">
          ...
          <div className='mb-10 lg:mb-0 flex justify-center'>
            <a href="https://github.com/EugenioAntonioBonanno" className='hover:opacity-70'>
              <svg xmlns="http://www.w3.org/2000/svg" height='65' viewBox="-0.2 -1 379 334">
          ...
          <div className='mb-10 lg:mb-0 flex justify-center'>
            <a href="https://www.linkedin.com/in/eugenio-bonanno/" className='hover:opacity-70'>
              <svg xmlns="http://www.w3.org/2000/svg" height="50" viewBox="1.786 1.783 287.865 76.248">
