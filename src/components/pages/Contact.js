...
const Contact = () => {
  ...
  return (
    <>
      ...
      <div className="max-w-screen-xl md:mt-24 mx-3 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 md:mx-auto bg-gray-200 text-gray-900 rounded-lg shadow-lg">
